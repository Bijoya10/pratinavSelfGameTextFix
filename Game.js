class Game {
  ...
  play() {
    ...
    if (distance >= 90 && distance < 100) {
      ...
      stroke("White");
      textSize(20);
      text("YOU ARE ABOUT TO ENTER THE STRATOSPHERE", width/2, 500);
    }
    ...
    if (distance >= 150 && distance < 200) {
      ...
      stroke("White");
      textSize(20);
      text("YOU ARE ABOUT TO ENTER THE EXOSPHERE", width/2, 500);
    }
   ...
   if (distance >= 380) {
      ...
      stroke("White");
      textSize(20);
      text("YOU ARE ABOUT TO REACH THE MARS", width/2, 500);
    } 
    ...
    stroke("White");
    textSize(20);
    text("GAME OVER ", width/2-100, 500);
  }
  won(){
    strokeWeight(10);
    stroke("White");
    ...
    text("YOU HAVE WON THE GAME",20, 600);
    rocket.destroyEach();
  }
