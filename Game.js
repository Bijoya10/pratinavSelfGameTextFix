class Game{
    ...
    play(){
      ...
      if(gamePosition==="playEarth"){
        ...
        background(mars);
        text("YOU HAVE WON THE GAME",500,500);
        rocket.destroyEach();
        gameState="end";
        }
      ...
      if(distance>=90 && distance<100){
        ...
        stroke("White");
        textSize(20);
        text("YOU ARE ABOUT TO ENTER THE STRATOSPHERE",500,500);
      }
      ...
      if(distance>=150 && distance<200){
        ...
        stroke("White");
        textSize(20);
        text("YOU ARE ABOUT TO ENTER THE EXOSPHERE",500,500);
      }
      ...
      if(distance>=380){
        ...
        stroke("White");
        textSize(20);
        text("YOU ARE ABOUT TO REACH THE MARS",800,500);
      }
        drawSprites();
        strokeWeight(4);
        stroke("White");
